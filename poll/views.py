...
from django.contrib.auth.decorators import login_required #for login in the pages to avoid direct access
...
def profile(request, username):
    user = User.objects.get(username=username) #gives all details of user Bikash
